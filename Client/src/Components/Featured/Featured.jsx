        ...
        {products.map((product) => (
          ...
          >
            <div className="product-info">
              ...
              <button className="shop-now" onClick={() => addToCart(product)}>
                Add to Cart
              </button>
            </div>
